  ...
  <section class="app-container">
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px; width: 100%;">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        <el-form-item>
          <el-input v-model="filters.name" placeholder="手机号" />
        </el-form-item>
        <el-form-item>
    ...
    <!--列表-->
    <el-table :data="users" border highlight-current-row style="width: 100%;" @selection-change="selsChange">
      <!-- <el-table-column width="50" /> -->
      <el-table-column type="index" label="编号" width="70" />
      <el-table-column prop="name" label="手机号" width="900" />
